...
namespace yy {
Driver::Driver()
    : cntx(), opTypePredefFactory(*this, defaultOpTypePredefined),
...
Errorable<ast::OpTypePredefined> Driver::getOpTypeByToken(OpTypeToken token) {
  return opTypePredefFactory.getOpTypePredefined(token);
};
